...
```
###Pdays
  Con el summary podemos ver que no tenemos outliers ni errores, tampoco missings. Sin embargo, debemos tratar los valores 999 con significado especial "nunca fueron contactados" por un valor que no desvirtue los demás. En ese sentido se ha optado por asignarles el máximo más 1.
...
Igual que en  el caso anterior, solo se sobrescriben las variables imputadas en nuestro df.
