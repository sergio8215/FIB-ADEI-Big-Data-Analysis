...
```
Al hacer condes, con todas las variables categóricas, contemplamos el uso de f.campaign, month, para nuestro modelo ya que la probabilidad de que no tengan relaciï¿½n con el target esta por debajo del 0.01. Como nos sale la versiï¿½n categorica de campaign que tambiï¿½n nos sale en el modelo númerico, debemos elegir entre una u otra pero nunca las dos a la vez.
