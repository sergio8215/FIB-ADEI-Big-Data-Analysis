...
res2.pca<-PCA(df[,c('duration',vars_num)],quanti.sup=1, graph=FALSE) # Hay que poner como suplemenmtaria la variable target. Convé treure
...
sel <- sort(res.pca$ind$contrib[,1], decreasing = TRUE)[1:15] # ver si hay alguna caracteristica relevnte, ver los 5 mas relevantes de este eje y del eje 2, ver que comparten en común.
