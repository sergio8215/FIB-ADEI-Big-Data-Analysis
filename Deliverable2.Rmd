...
# preguntar eigens vectors y aigen values. tambien porque se hace la matriz de correlacion con la misma matriz del vector propio
...
plot(res.pca$eig[,1],main="Eigenvalues",names.arg=paste("dim",1:nrow(res.pca$eig)),type="o", col="blue") # preguntar el elbow esta antes de la dimension 2?
