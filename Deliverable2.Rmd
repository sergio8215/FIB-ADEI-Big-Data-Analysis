...
res.pca<-PCA(df[,c('duration',vars_num)],quanti.sup=1, graph=FALSE) # Hay que poner como suplemenmtaria la variable target. Convé treure pdays ja que té molts missings
