...
res.pca<-PCA(df[,c('duration',vars_num, "f.job","f.season")],cex=0.75,quanti.sup=1, quali.sup = c(11:12))
plot.PCA(res.pca,choix="ind",invisible="ind",cex=0.75)

res.pca<-PCA(df[,c('duration',vars_num,"f.education","f.age")],cex=0.75,quanti.sup=1, quali.sup = c(11:12))
plot.PCA(res.pca,choix="ind",invisible="ind",cex=0.75)

res.pca<-PCA(df[,c('duration',vars_num,"f.pdays","y")],cex=0.75,quanti.sup=1, quali.sup = c(11:12))
plot.PCA(res.pca,choix="ind",invisible="ind",cex=0.75)
