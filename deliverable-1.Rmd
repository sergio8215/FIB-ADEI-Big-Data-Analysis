...
# Para pdays
sin_999<-which(df$pdays<999)
summary(df$pday[sin_999])
summary(factor(df$pday[sin_999])) # Podemos ver que se puede separar en 4 bloques
aux2<-c(0,3,6,998,999) # Niveles para que este relativamente bien repartido
