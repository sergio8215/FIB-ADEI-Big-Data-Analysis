...
#Para pdays/previous/outcome creemos que estan relacionadas, por lo que podemos detectar errores si encontramos algún valor nonexistent ó 0 y que no sea 0 ó nonexistent respectivamente y además pdays=999
  ...
  # preguntar porque la ultima diferencia da 527
  ...
  dqri[aux,'missings']<-dqri[aux,'missings']+1
	...
	aux<-which(df$previous>3);length(aux);df[aux,'previous'] # En vista de los limites de los outliers leves y graves que coinciden en uno, hemos decidio eliminar los valores mayores a 3, los cuales son solo 9.
