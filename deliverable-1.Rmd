...
#Para pdays/previous/outcome podemos detectar errores si encontramos algún valor 999 ó 0 ó nonexistent respectivamente que no esté en la tripleta de esos tres valores
  ...
  }#Aparecen muchas discordancias #preguntar si es necesario cosiderar errores
  ...
  summary(df$cons.conf.idx)
	...
	aux<-calcQ(df$cons.conf.idx);aux
	abline(h=aux[8],col="red",lwd=2) #Fijamos límite soft
	abline(h=aux[9],col="magenta",lwd=2) #Fijamos límite extreme
