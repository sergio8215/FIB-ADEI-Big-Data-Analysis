...
# Para el data analisis guardamos los outliers
dqr[variable="duration","outliers"]<-6
...
# Para el data analisis guardamos los errores
dqr[variable="duration","error"]<-length(aux)
...
for(i in vars_cat){ 
	dqr[variable=i,"missing"]<-sum(is.na(df[,i]))
	dqr[variable=i,"outliers"]<-0
	dqr[variable=i,"error"]<-0
}
